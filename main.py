...
if args.do_direct_eval:
    ...
    model.model.load_state_dict(torch.load(os.path.join(args.output_dir, "pytorch_model.bin")))
    # model.model = torch.load(os.path.join(args.output_dir, 'pytorch_model.bin'));
